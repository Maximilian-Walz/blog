          ...
          <div className="hidden h-full max-h-screen min-w-[280px] max-w-[280px] flex-wrap overflow-auto rounded bg-gray-900/70 pt-5 shadow-md shadow-gray-800/40 sm:flex">
            <div className="px-6 py-4">
              {pathname.startsWith('/blog') ? (
                ...
                <Link
                  href={`/blog`}
                  className="font-bold uppercase text-gray-300 hover:text-primary-500"
                >
                  All Posts
                </Link>
              )}
                  ...
                  return (
                    <li key={t} className="my-3">
                      {pathname.split('/tags/')[1] === slug(t) ? (
                        ...
                        <Link
                          href={`/tags/${slug(t)}`}
                          className="px-3 py-2 text-sm font-medium uppercase text-gray-300 hover:text-primary-500"
